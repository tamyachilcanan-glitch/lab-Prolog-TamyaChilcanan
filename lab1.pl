...
% (Ya hay 14+ hechos con 3 generaciones)
...
% Recursiva: X es ancestro de Y si X es progenitor de Z y X es ancestro de Z, o
% si algún descendiente intermedio Z conecta X con Y.
...
factorial(N, F) :-
    ...
    N1 is N - 1,                                 % N1 = N - 1   (is evalúa la aritmética)
